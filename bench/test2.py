...
if args.pv_accum_dtype == 'fp32':
    kernel_int4 = qattn.qk_int4_sv_int4_accum_f32_attn # the kernel with fully fp32 accumulator
elif args.pv_accum_dtype == 'fp16+fp32':
    kernel_int4 = qattn.qk_int4_sv_int4_accum_f16_attn_inst_buf if headdim == 64 else qattn.qk_int4_sv_f16_accum_f16_attn_buf # the kernel with fp32 longterm buffer and fp16 shortterm accumulator
elif args.pv_accum_dtype == 'fp16':
    kernel_int4 = qattn.qk_int4_sv_int4_accum_f16_attn # the kernel with fully fp16 accumulator
...
if args.pv_accum_dtype == 'fp32':
    ...
    kernel_int8 = qattn.qk_int8_sv_f16_accum_f16_attn # the kernel with fully fp16 accumulator
